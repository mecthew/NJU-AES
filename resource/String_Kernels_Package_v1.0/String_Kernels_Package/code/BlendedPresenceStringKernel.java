/*
 This code computes the blended presence bits string kernel.
...
public class BlendedPresenceStringKernel
{
    private int ngramMinLength;
    private int ngramMaxLength;

    public BlendedPresenceStringKernel(int ngramMinLength, int ngramMaxLength)
    {
        this.ngramMinLength = ngramMinLength;
        this.ngramMaxLength = ngramMaxLength;
    }

    public BlendedPresenceStringKernel()
    {
        this(1, 5);
    }
    
    // Computes the blended presence kernel among two strings.
    ...
    // Computes the blended presence kernel matrix for a set of samples.
    ...
    // Computes the blended presence kernel matrix among two sets of samples.
